...
* Option 2: Follow [this link](https://code.earthengine.google.com/?scriptPath=users%2Fgisizw%2FGEE-PICX%3AGEE-PICX) to directly open the application in Google Earth Engine's code editor mode.
